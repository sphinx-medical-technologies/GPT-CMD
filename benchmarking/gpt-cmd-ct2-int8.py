...
# load on GPU
generator = ctranslate2.Generator("/home/silvacarl/Desktop/models/gpt-cmd-int8/",device="cuda")

# load on CPU
# generator = ctranslate2.Generator("../models/gpt-cmd-int8/")

tokenizer = transformers.AutoTokenizer.from_pretrained("EleutherAI/gpt-j-6B")
# tokenizer = transformers.AutoTokenizer.from_pretrained("../models/gpt-cmd-int8/")
