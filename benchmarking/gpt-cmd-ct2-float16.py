...
# load on GPU
generator = ctranslate2.Generator("/home/silvacarl/Desktop/models/gpt-cmd-float16/",device="cuda")

# load on CPU
# generator = ctranslate2.Generator("/home/silvacarl/Desktop/models/gpt-cmd-float16/")

tokenizer = transformers.AutoTokenizer.from_pretrained("EleutherAI/gpt-j-6B")
# tokenizer = transformers.AutoTokenizer.from_pretrained("../models/gpt-cmd-float16/")
